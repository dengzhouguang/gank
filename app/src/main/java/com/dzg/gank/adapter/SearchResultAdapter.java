...
public class SearchResultAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType==TYPE_IMAGE){
            ...
            return new SearchResultViewHolder2(view);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        SearchResultViewHolder myHolder = (SearchResultViewHolder) holder;
        myHolder.bindData(mList.get(position));
        }else {
            SearchResultViewHolder2 myHolder = (SearchResultViewHolder2) holder;
            myHolder.bindData(mList.get(position));
        }
    }
    ...
    public void setData(List<GankBean.ResultsBean> list){
        mList.clear();
        mList.addAll(list);
        notifyDataSetChanged();
    }
    ...
    class SearchResultViewHolder2 extends RecyclerView.ViewHolder {
        @BindView(R.id.item_title)
        TextView titleTv;
        @BindView(R.id.item_time)
        TextView timeTv;
        ...
        private String url;
        public SearchResultViewHolder2(View itemView) {
            super(itemView);
            ButterKnife.bind(this,itemView);
